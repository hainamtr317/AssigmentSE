...
public class Main {
	...
	public static void main(String args[]) {
		...
		system.addCar("343214", "BLACK", "2010", CarStatusType.RENT_READY, Arrays.asList(CarType.COMPACT_CAR,CarType.VAN, CarType.FULL_SIZE), "123" , "1");
		system.addCar("932413", "RED", "2014", CarStatusType.RENT_READY, Arrays.asList(CarType.STATION_WAGON,CarType.ECONOMY, CarType.MEDIUM_SIZE), "123" , "1");
